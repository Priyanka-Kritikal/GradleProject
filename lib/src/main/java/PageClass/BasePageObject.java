...
public class BasePageObject {
	...
	public void scrollToTheElementOnThePage(WebDriver driver, WebElement webElement) {
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("arguments[0].scrollIntoView(true);", webElement);

		try {
			Thread.sleep(TestUtilities.PAGE_LOAD_LONG_WAIT);
	...
	//Type given integer into element with given locator
	public void enterNumber(int i, By locator) {
		waitForVisibilityOf(locator,Duration.ofSeconds(20));
		find(locator).sendKeys(String.valueOf(i));	
	}
